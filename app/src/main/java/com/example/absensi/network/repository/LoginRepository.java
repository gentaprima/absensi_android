...
public class LoginRepository {
    ...
    public MutableLiveData<ResponseLogin> getResponseLogin(String email,String password,String device_id){
        final MutableLiveData<ResponseLogin> responseLoginMutableLiveData = new MutableLiveData<>();
        Call<ResponseLogin> requestOrder = apiInterface.loginUser(email,password,device_id);
